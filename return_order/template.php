            ...
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-4 text-right">
                  <div>目前資料筆數:<?php echo $total_records; ?></div>
                  <a href="add.php">新增退換貨訂單</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <table border="1" align="center" class="table table-bordered table-hover mt-2">
                <tr class="table-info">
                  <th>ID</th>
                  <th>訂單編號</th>
                  <th>姓名</th>
                ...
                while ($row_result = $result->fetch_assoc()) {
                  ...
                  echo "<td><a href='update.php?id=" . $row_result["ID"] . "'>修改</a> &nbsp&nbsp&nbsp&nbsp&nbsp";
