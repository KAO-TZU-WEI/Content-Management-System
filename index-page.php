...
require_once './app/controllers/isLoadingFromViewsIndex.php';
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <?php
          $welcome = new Mydb();
          //$welcome->select("SELECT username FROM admin WHERE username=")
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="./index-page.php" class="nav-link active">
