        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="member-add.php" class="nav-link active">
            ...
            <div id="personal-form" class="row">
              ...
              <!-- general form elements -->
                 <div class="card card-info">
                        ...
                        <div class="card-body">
                          ...
                          <label for="" class="d-block">會員等級 :</label>
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio1">付費會員</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="member" id="inlineRadio2" value="2">
                                <label class="form-check-label" for="inlineRadio2">一般會員</label>
                              </div>
                          </div>
                    ...
                    <!-- /.form group -->
                    <div class="form-group">
                        <label for="love">撰寫文章數量(預設)</label>
                        <input type="text" class="form-control" name="love" id="love">
                    </div>

                    <div class="form-group">
                        <label for="love">蒐藏文章數量(預設)</label>
                        <input type="text" class="form-control" name="lova-artical-num" id="love">
                    </div>

                    <div class="form-group">
                        <label for="love">喜歡的商品數量(預設)</label>
                        <input type="text" class="form-control" name="love-item-num" id="love">
                    </div>

                    <div class="form-group">
                        <label for="buy">訂單數量(預設)</label>
                        <input type="text" class="form-control" name="order-record" id="buy">
                    </div>
                    <div class="form-group">
                        <label for="buy">折價券數量(預設)</label>
                        <input type="text" class="form-control" name="discount-num" id="buy">
                    </div>
                           ...
                           <div class="row">
                             ...
                             <div class="col-5">
                              <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-info" style="padding: 5px 15px;">新增</button>
                                </div>
                             </div>
