...
<body>
    <div class="container ">
        <header class="pt-5 ">
            <h1 class="text-info font-weight-bold">文章修改</h1>
        </header>
        <?php
        while ($row = $stmt->fetch()) {
        ?>
            <div class="py-3"></div>
            <form class="form-group" action="travel-notes-editorUpdate.php" method="post">
                <div style="display: none;">
                    <input type="text" name="id" value="<?= $row["travel_notes_id"] ?>">
                </div>
                <div class="form-group ">
                    <label for="">文章標題</label>
                    <input type="text" name="tittle" id="" class="form-control" value="<?= $row["travel_notes_title"] ?>">
                </div>
                <div class="form-group">
